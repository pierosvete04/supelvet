...
const rHistStart = 1066;
const rHistEnd = 1112; // function anularVenta(id){ is at 1114

const before = lines.slice(0, rHistStart).join('\n');
const after = lines.slice(rHistEnd + 1).join('\n'); // keep anularVenta
...
fs.writeFileSync('index_1_corregido.html', before + '\n' + agruparCode + '\n' + after, 'utf8');
